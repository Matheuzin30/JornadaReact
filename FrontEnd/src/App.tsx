...
export function App() {
  const [isGuesInputOpen, setIsGuesInputOpen] = useState(false)
  ...
  const[emailsToInvite, setemailsToInvite] = useState([
    ...
    function openGuesInput(){
      setIsGuesInputOpen(true)
    }

    function closeGuesInput(){
        ...
        <p className="text-sm text-zinc-300">Convite seus amigos e familiares para sua próxima viagem!</p>
         ...
         <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <MapPin className='size-5 text-zinc-400 stroke-blue-600' />
            <input 
            disabled ={isGuesInputOpen}
            ...
            <div className='flex items-center gap-2'>
              <Calendar className='size-5 text-zinc-400 stroke-blue-600' />
              <input 
              disabled={isGuesInputOpen} 
            ...
            {isGuesInputOpen ? (
              <button onClick={closeGuesInput}className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>
                Alterar local/data
                <Settings2 className='size-5' />
                </button>
            ) : (
              <button onClick={openGuesInput} className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
            Continuar
